...
- [ ] Backend Core: move story generation off the HTTP request using the existing BullMQ queue/StoryGenerationProcessor — blocked: waiting for the user to send the Backend Core version that contains them.
